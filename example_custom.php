<?php 
	...
	//Группировка (dimension)
	$metrika->dimensions = array('ym:s:lastTrafficSource','ym:s:lastSourceEngine');

	//Метрика (metric)
	$metrika->metrics = array('ym:s:visits', 'ym:s:users', 'ym:s:bounceRate', 'ym:s:pageDepth', 'ym:s:avgVisitDurationSeconds');
